    ...
    <footer className="bg-gray-900 text-white py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            <h3 className="text-xl font-bold mb-4">Tom BALLESTER</h3>
            <p className="text-gray-400">
              Développeur Web passionné créant des expériences web modernes et intuitives.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#skills" className="text-gray-400 hover:text-white transition">Compétences</a></li>
              <li><a href="#projects" className="text-gray-400 hover:text-white transition">Projets</a></li>
